...
\begin{abstract}
This document contains the solution to calculate the angle between 2 vectors $\Bar{\textbf{a}}$ and $\Bar{\textbf{b}}$.
\end{abstract}
Download all python codes from 
%
\begin{lstlisting}
https://github.com/gaurav-1205/EE5609-MatrixTheory/
\end{lstlisting}
%
...
\section{Problem}
 ...
 Find the angle between 2 vectors $\textbf{a} = $
 $\begin{pmatrix}
1 \\ 
1 \\ 
-1 
...
\implies \|\textbf{a}\| * \|\textbf{b}\| = \sqrt{3}*\sqrt{3}\\
...
Therefore, the angle between the 2 vectors is $109.47\degree$.
